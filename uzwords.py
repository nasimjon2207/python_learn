...
words = [
    "shifokor", "bemor", "kasal", "dorixona", "dori", "shprits", "ukol", "shifoxona", "apteka", "muolaja",
    "davolash", "jarrohlik", "tibbiyot", "tahlil", "rentgen", "qon", "bosim", "shakar", "yurak", "o‘pka",
    "tomir", "oshqozon", "ichak", "buyrak", "jigar", "nafas", "gripp", "shamollash", "isitma", "tumov",
    "yo‘tal", "tomoq", "diabet", "allergiya", "ko‘z", "quloq", "burun", "tish", "milk", "jarroh",
    "xavfli", "infeksiya", "virus", "bakteriya", "emlash", "antibiotik", "suv", "parhez", "vitamin",
